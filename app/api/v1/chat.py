...
@router.post(
    ...
    status_code=201,
    summary="Add messages to chat",
    description="Send messages to a chat session. Roles must be 'user', 'assistant', or 'system'. In Phase 3, user messages will trigger AI responses.",
    responses={
        401: {"description": "Not authenticated"},
        404: {"description": "Session not found"},
...
async def add_messages(
    ...
    return await chat_service.add_messages(db, current_user, session_id, messages)
