  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8">
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Learning Roadmaps</h1>
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Step-by-step plans for your career path</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="rounded-xl border-2 border-dashed border-gray-200 bg-white p-12 text-center dark:border-gray-700 dark:bg-gray-800">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">No roadmaps yet</h3>
          <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Roadmaps will appear here once the AI generates personalized learning paths for you.</p>
